/**
 * API Endpoint: Search Stripe Customers (using fetch instead of SDK)
 * GET /api/stripe-customers-fetch?search=query
 *
 * Searches Stripe customers by name, email, or metadata (boat name)
 * Uses direct HTTP fetch instead of Stripe SDK
 */
